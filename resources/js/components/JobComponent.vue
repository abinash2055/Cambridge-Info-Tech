        ...
        <div class="row">
            <div class="col-sm-12 col-md-5 col-xl-4">
                <Sidebar
                    ...
                    @get-by-salary="getBySalary"
                    @get-by-district="getByDistrict"
                />
            </div>
                ...
                <div class="card" v-else>
                    ...
                    <div class="my-4 text-center small">
                        <div class="d-block py-2 text-muted">
                            {{ posts.total }} Total Jobs found with matching
                            search
                        </div>
...
export default {
    ...
    methods: {
        ...
        getByDistrict(district) {
            this.$Progress.start();
            axios
                .get(`/api/search?district=${district}`)
                .then((res) => res.data)
                .then((data) => {
                    this.posts = data;
                    this.$Progress.finish();
