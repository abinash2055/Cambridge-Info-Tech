                        ...
                        <div class="company-info">
                            <div class="company-banner">
                                ...
                                @if ($company->cover_img == 'nocover')
                                    <img src="{{ asset('images/companies/nocover.jpg') }}"
                                        class="company-banner-img img-fluid" alt="">
                                @else
                                    <img src="{{ asset($company->cover_img) }}" class="company-banner-img img-fluid"
                                        alt="">
                                @endif
                                <div class="company-media">
                                    <img src="{{ asset($company->logo) }}" alt="" class="company-logo">
                                    <div>
                                        <a href="{{ route('employer.show', ['employer' => $company]) }}"
                        ...
                        <div class="job-info">
                            <div class="job-hdr p-3">
                                ...
                                <div class="">
                                    <p class="job-views">
                                        ...
                                        <span class="text-danger">Apply Before: {{ date('d', $post->remainingDays()) }}
                                            days</span>
                                    </p>
                                </div>
                            </div>
                            <div class="job-bdy p-3 my-3">
                                    ...
                                    <table class="table table-hover">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td width="3%">:</td>
                                                <td width="64%"><a
                                                        href="/jobs">{{ $company->getCategory->category_name }}</a></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td width="3%">:</td>
                                                <td width="64%" class="text-danger">
                                                    {{ date('l, jS \of F Y', $post->deadlineTimestamp()) }},
                                                    ({{ date('d', $post->remainingDays()) }} days from now)</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <a href="{{ route('account.applyJob', ['post_id' => $post]) }}"
                                            class="btn primary-btn">Apply now</a>
                                        <a href="{{ route('account.savedJob.store', ['id' => $post]) }}"
                        ...
                        <div class="card-body">
                            <div class="btn-group w-100">
                                <a href="{{ route('account.applyJob', ['post_id' => $post->id]) }}"
                                    class="btn primary-outline-btn float-left">Apply Now</a>
                                <a href="{{ route('account.savedJob.store', ['id' => $post->id]) }}"
                                    class="btn primary-btn"><i class="fas fa-star"></i> Save job</a>
                            </div>
                        </div>
                    </div>
                    <div class="card ">
                                        ...
                                        <div class="job-item border-bottom row">
                                            ...
                                            <div class="job-desc col-8">
                                                <a href="{{ route('post.show', ['job' => $post]) }}"
                                                    ...
                                                    <p class="font-weight-normal small text-danger">Deadline:
                                                        {{ date('d', $job->remainingDays()) }} days</p>
                                                </a>
                                            </div>
                                        </div>
                                    @else
