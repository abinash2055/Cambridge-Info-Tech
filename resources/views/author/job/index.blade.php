              ...
              <tbody>
                @if($applications && $applications->count())
                  ...
                  <tr>
                    ...
                    <td><a href="{{route('author.jobApplication.show',['id'=>$application])}}" class="btn primary-outline-btn">View</a>
                      <form action="{{route('author.jobApplication.destroy')}}" method="POST" class="d-inline-block">
                        @csrf
                        @method('delete')
