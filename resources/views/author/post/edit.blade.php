         ...
         <form action="{{ route('author.post.update', $post->id) }}" method="POST">
             ...
             <div class="mb-3">
                 ...
                 <select name="job_location" class="form-control" id="job_location" required>
                     <option value="" disabled {{ is_null($post->job_location) ? 'selected' : '' }}>Select JobLocation</option>
                     ...
                     <option value="Dadeldhura" {{ $post->job_location == 'Dadeldhura' ? 'selected' : '' }}>Dadeldhura</option>
                     ...
                     <option value="Eastern Rukum" {{ $post->job_location == 'Eastern Rukum' ? 'selected' : '' }}>Eastern Rukum</option>
                     ...
                     <option value="Kanchanpur" {{ $post->job_location == 'Kanchanpur' ? 'selected' : '' }}>Kanchanpur</option>
                     <option value="Kapilvastu" {{ $post->job_location == 'Kapilvastu' ? 'selected' : '' }}>Kapilvastu</option>
                     ...
                     <option value="Mahottari" {{ $post->job_location == 'Mahottari' ? 'selected' : '' }}>Mahottari</option>
                     ...
                     <option value="Rupandehi" {{ $post->job_location == 'Rupandehi' ? 'selected' : '' }}>Rupandehi</option>
                     <option value="Salyan" {{ $post->job_location == 'Salyan' ? 'selected' : '' }}>Salyan</option>
                     <option value="Sankhuwasabha" {{ $post->job_location == 'Sankhuwasabha' ? 'selected' : '' }}>Sankhuwasabha</option>
                     ...
                     <option value="Solukhumbu" {{ $post->job_location == 'Solukhumbu' ? 'selected' : '' }}>Solukhumbu</option>
                     ...
                     <option value="Taplejung" {{ $post->job_location == 'Taplejung' ? 'selected' : '' }}>Taplejung</option>
                     <option value="Terhathum" {{ $post->job_location == 'Terhathum' ? 'selected' : '' }}>Terhathum</option>
                     <option value="Udayapur" {{ $post->job_location == 'Udayapur' ? 'selected' : '' }}>Udayapur</option>
                     <option value="Western Rukum" {{ $post->job_location == 'Western Rukum' ? 'selected' : '' }}>WesternRukum</option>
