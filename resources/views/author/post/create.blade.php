      ...
      <div class="col-sm-12 col-md-12">
        <form action="{{route('author.post.store')}}" id="postForm" method="POST">
          ...
          <div class="form-group mb-3">
            ...
            <input type="text" placeholder="Job title" class="form-control @error('job_title') is-invalid @enderror" name="job_title" value="" required autofocus>
            @error('job_title')
          ...
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <input type="number" class="form-control @error('vacancy_count') is-invalid @enderror" name="vacancy_count" value="" min="0" required>
                @error('vacancy_count')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
