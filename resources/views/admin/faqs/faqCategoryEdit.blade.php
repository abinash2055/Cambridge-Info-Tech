...
<div class="container">
    ...
    <form action="{{ route('faq.categories.update', $faqCategory->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="name" id="name" value="{{ old('name', $faqCategory->name) }}" required>
        </div>
        ...
        <a href="{{ route('faq.categories.index') }}" class="btn btn-secondary">Cancel</a>
    </form>
</div>
@endsection
