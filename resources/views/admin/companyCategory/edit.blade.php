        ...
        <div class="col-12">
          ...
          <form action="{{route('admin.category.update',['id'=>$category->id])}}" method="POST">
            ...
            <div class="form-group">
              ...
              <input type="text" placeholder="Edit your category name here" name="category_name" value="{{ old('category_name')??$category->category_name }}" class="form-control @error('category_name') input-error @enderror">
            </div>
            <div class="d-flex">
