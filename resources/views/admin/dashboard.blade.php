            ...
            <section class="dashboard-authors my-5">
                <div class="row my-4">
                    <div class="col-lg-12 col-md-8 col-sm-12">
                                    ...
                                    @foreach ($recentAuthors as $author)
                                        @if ($author->company)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('employer.show', ['employer' => $author->company]) }}"
                                                        class="btn primary-btn">View Company</a>
                                                </td>
                                            </tr>
                                        @endif
                                    @endforeach
                        ...
                        <button class="btn primary-outline-btn disabled">Total Number of authors registered
                ...
                <div class="row my-4">
                    <div class="col-sm-12 col-md-12">
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" href="#categories-tab" role="tab" data-toggle="tab">Company
                                    Categories</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#role-have-permission-tab" role="tab" data-toggle="tab">Roles
                                    have permissions</a>
                            </li>
                            ...
                            <div role="tabpanel" class="tab-pane active" id="categories-tab">
                                <div class="mb-3">
                                    <form action="{{ route('admin.category.store') }}" method="POST">
                                        ...
                                        <div class="d-flex">
                                            <input type="text" class="form-control" placeholder="Company category name"
                                                name="category_name">
                                            ...
                                            @foreach ($companyCategories as $category)
                                                <tr>
                                                    ...
                                                    <td><a class="btn secondary-btn"
                                                            href="{{ route('admin.category.edit', ['category' => $category]) }}">Edit</a>
                                                        <form method="POST"
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a class="btn secondary-btn" href="">Edit</a>
                                                        <form action="" class="d-inline"><button type="submit"
                                                                class="btn danger-btn">Delete</button></form>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
