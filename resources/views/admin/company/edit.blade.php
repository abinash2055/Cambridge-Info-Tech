...
@section('content')
    <div class="account-layout border">
        <div class="account-hdr bg-primary text-white border text-center">
            Edit Company
        </div>
        <div class="account-bdy p-3">
            ...
            @endif
            <form action="{{ route('admin.company.update', ['id' => request()->route('id')]) }}" method="POST"
                ...
                <div class="pb-3">
                    <div class="py-3">
                        <p class="font-weight-bold">Company logo</p>
                ...
                <div class="form-group">
                    <div class="pt-3">
                        <p class="font-weight-bold">Company Website Url</p>
                ...
                <div class="pb-3">
                    <div class="py-3">
                        <p class="py-2" class="font-weight-bold">Company banner/cover</p>
